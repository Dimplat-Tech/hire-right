...
"Knowledge of financial systems, security & compliance"
  ...
  },
  {
    ...
    requirements: [
      ...
      "Minimum of 5 years' experience supporting C-suite executives, preferably in a tech-enabled or multi-entity environment.",
      "Proven ability to manage complex projects, multitask, and execute with precision.",
      "Demonstrated leadership potential and interest in progressing toward a COO role.",
      "Professional discretion, strategic mindset, and organizational excellence.",
      "Strong analytical and problem-solving skills."
    ],
    about:
      "Provide strategic and administrative support across multiple tech-driven businesses. Help streamline operations, manage key initiatives, and coordinate cross-company activities.",
    location: "Lagos, Nigeria",
    mode: "On-site",
    type: "Full time",
    salary: "3,000,000 Annually",
    duties: ["Strategic planning", "Project coordination", "Executive support", "Operations management", "& more"],
    posted: "11/12/2025",
    logo: "/img/landing/Logo.svg",
    locate:"/jobopening/locate.png",
    calendar:"/jobopening/calendar.png",
    locatebar:"/jobopening/locationr.png",
    link:"https://bit/hirerightrecruitment",
    image: "/img/jobs/job16.jpeg",
  },
  {
    id: "j-17",
    company: "Hire Right",
    role: "Weekend Operations Manager",
    requirements: [
      "Bachelor's Degree in Business Administration, Retail Management, or a related field (preferred).",
      "Minimum of 3 years' experience in retail or supermarket operations, preferably within an FMCG environment.",
      "Proficiency in POS systems and basic inventory management tools.",
      "Strong attention to detail and ability to ensure compliance with hygiene and safety standards.",
      "Availability to work full weekends and public holidays as required.",
      "Excellent communication, multitasking, and problem-solving abilities."
    ],
    about:
      "Oversee supermarket activities to ensure smooth operations, strong sales, and excellent customer service. Supervise staff, manage inventory, and uphold store standards.",
    location: "Lagos, Nigeria",
    mode: "Hybrid",
    type: "Full time",
    salary: "2,400,000 Annually",
    duties: ["Operations management", "Staff supervision", "Inventory control", "Customer service", "& more"],
    posted: "11/12/2025",
    logo: "/img/landing/Logo.svg",
    locate:"/jobopening/locate.png",
    calendar:"/jobopening/calendar.png",
    locatebar:"/jobopening/locationr.png",
    link:"https://bit/hirerightrecruitment",
    image: "/img/jobs/job17.jpeg",
  },
  {
    id: "j-18",
    company: "Hire Right",
    role: "Store Keeper / Inventory Manager",
    requirements: [
      "OND / HND / Bachelor's Degree in Business Administration, Accounting, Supply Chain Management, or a related field.",
      "2–4 years' experience in store or inventory management, preferably in a supermarket or retail environment.",
      "Strong organizational and analytical abilities with excellent attention to detail.",
      "Proficiency in Microsoft Excel and inventory management systems (POS or ERP tools).",
      "Capacity to work independently and manage physical aspects of inventory handling."
    ],
    about:
      "Oversee all inventory operations from receiving and storing goods to issuing and documenting stock. Maintain optimal stock levels and prevent losses.",
    location: "Lagos, Nigeria",
    mode: "On-site",
    type: "Full time",
    salary: "1,800,000 – 2,040,000 Annually",
    duties: ["Inventory management", "Stock control", "Goods receiving", "Documentation", "& more"],
    posted: "11/12/2025",
    logo: "/img/landing/Logo.svg",
    locate:"/jobopening/locate.png",
    calendar:"/jobopening/calendar.png",
  ...
  },
  {
    ...
    requirements: [
      "Bachelor's degree in Graphic Design, Communications, Marketing, or any related field (or equivalent experience).",
      "Ability to comfortably work around children and support content creation involving kids.",
      "Ability to work independently, follow instructions, and manage multiple tasks.",
      "High attention to detail and the ability to deliver under tight timelines.",
      "Basic knowledge of social media platforms and digital content trends.",
      "Proficiency in Adobe Creative Suite (Photoshop, Illustrator, InDesign) or Canva."
    ],
    about:
      "Support in planning, developing, and executing creative content and personal projects. Work closely on a variety of visual, lifestyle, and content-related tasks.",
    location: "Lagos, Nigeria",
    mode: "On-site",
    type: "Full time",
    salary: "1,800,000 - 2,040,000 Annually",
    duties: ["Content creation", "Design support", "Creative development", "Project coordination", "& more"],
    posted: "11/12/2025",
    logo: "/img/landing/Logo.svg",
    locate:"/jobopening/locate.png",
    calendar:"/jobopening/calendar.png",
  ...
  },
  {
    ...
    requirements: [
      ...
      "2–5 years of experience in business development or sales (experience in printing/branding industry is a strong advantage).",
      "Goal-oriented, self-motivated, and able to work independently with minimal supervision.",
      "Good understanding of printing processes (digital, large format, offset) and branding materials is a plus.",
      "Strong relationship building and communication skills."
    ],
    about:
      "Drive revenue growth, expand the company's client base, and identify new business opportunities within the printing and branding industry.",
    location: "Lagos, Nigeria",
    mode: "On-site",
    type: "Full time",
    salary: "4,800,000 Annually",
    duties: ["Business development", "Client acquisition", "Sales management", "Relationship building", "& more"],
    posted: "11/12/2025",
    logo: "/img/landing/Logo.svg",
    locate:"/jobopening/locate.png",
    calendar:"/jobopening/calendar.png",
